// Adapted from https://github.com/qawolf/playwright-video/blob/master/src/ScreencastFrameCollector.ts
...
import {CDPSession} from "puppeteer-core/lib/cjs/puppeteer/common/Connection";
